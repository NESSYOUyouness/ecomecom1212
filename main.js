        ...
        <div id="${product.id}" class="product">
          <div class="details">
            ...
            <div class="product-info">
              <p class="product-name" dir="rtl">${product.name}</p>
              <p class="product-price">$${product.price}
              <span id="phone-total" class="small">$${product.price2}</span>
              </p>
          ...
          <div class="controls">
            <div class="quantity">
                ...
                <button data-product-id="${product.id}" class="decrement-btn add_prod">
                  <i class="fa-solid fa-minus fa-sm"></i>
                </button>
                <p class="quantity-num add_prod" >${product.quantity}</p>
...
const addEvents = () => {
  ...
  const removClassOne = document.querySelectorAll(".add_prod");
  // const removClassTwo = document.querySelectorAll(".quantity-num");
  ...
  allIncrementButtons.forEach((incrementButton) => {
    incrementButton.addEventListener("click", () => {
      ...
      removClassOne.forEach((removClass) => { 

        
          removClass.classList.remove('add_prod');
